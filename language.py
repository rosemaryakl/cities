...
def generate_country_code_to_countries(json_filepath):
    with open(json_filepath) as json_file:
...
language_code_to_cities_dict = generate_country_code_to_countries(LNG_JSON) # ex {'AD': ['Sant Julià de Lòria']} 
...
language_name_or_code = input('Enter a Country Name / Code: ')
